...
namespace VoteMonitor.Entities
{
    public static class VotingContextExtensions
    {
        ...
        {
            context.Clear<OptionToQuestion>();
            context.Clear<Question>();
            context.Clear<FormSection>();
            context.Clear<Form>();
            context.Clear<County>();
            context.Clear<Observer>();
        }
        ...
        private static void Clear<T>(this DbContext context) where T : class
